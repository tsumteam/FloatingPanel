...
public protocol FloatingPanelBehavior {
    ...
    @objc optional
    func addAnimator(_ fpc: FloatingPanelController, to: FloatingPanelState) -> UIViewPropertyAnimator
    ...
    /// Default is an animator with ease-in-out curve and 0.25 sec duration.
    @objc optional
    func removeAnimator(_ fpc: FloatingPanelController, from: FloatingPanelState) -> UIViewPropertyAnimator
    ...
    /// Default is an animator with ease-in-out curve and 0.25 sec duration.
    @objc optional
    func moveAnimator(_ fpc: FloatingPanelController, from: FloatingPanelState, to: FloatingPanelState) -> UIViewPropertyAnimator
