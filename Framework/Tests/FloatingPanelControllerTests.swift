...
class FloatingPanelControllerTests: XCTestCase {
    ...
    func test_originSurfaceY() {
        ...
        fpc.move(to: .full, animated: false)
        XCTAssertEqual(fpc.surfaceEdgeLocation, fpc.surfaceEdgeLocation(for: .full))
        fpc.move(to: .half, animated: false)
        XCTAssertEqual(fpc.surfaceEdgeLocation, fpc.surfaceEdgeLocation(for: .half))
        fpc.move(to: .tip, animated: false)
        XCTAssertEqual(fpc.surfaceEdgeLocation, fpc.surfaceEdgeLocation(for: .tip))
        fpc.move(to: .hidden, animated: false)
        XCTAssertEqual(fpc.surfaceEdgeLocation, fpc.surfaceEdgeLocation(for: .hidden))
    }
    ...
    func test_contentMode() {
        ...
        fpc.move(to: .full, animated: false)
        XCTAssertEqual(fpc.surfaceView.frame.height, fpc.view.bounds.height - fpc.surfaceEdgeLocation(for: .full).y)
        fpc.move(to: .half, animated: false)
        XCTAssertEqual(fpc.surfaceView.frame.height, fpc.view.bounds.height - fpc.surfaceEdgeLocation(for: .full).y)
        fpc.move(to: .tip, animated: false)
        XCTAssertEqual(fpc.surfaceView.frame.height, fpc.view.bounds.height - fpc.surfaceEdgeLocation(for: .full).y)
        ...
        XCTAssertEqual(fpc.surfaceView.frame.height, fpc.view.bounds.height - fpc.surfaceEdgeLocation(for: .half).y)
        fpc.move(to: .tip, animated: false)
        XCTAssertEqual(fpc.surfaceView.frame.height, fpc.view.bounds.height - fpc.surfaceEdgeLocation(for: .tip).y)
    }
}
